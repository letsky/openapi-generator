...
public class ArkTSAxiosClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public static final String DEFAULT_AXIOS_VERSION = "^2.2.6";
    ...
    public ArkTSAxiosClientCodegen() {
        super();
        ...
        outputFolder = "generated-code/arkts-axios";
        embeddedTemplateDir = templateDir = "arkts-axios";
    ...
    public String getHelp() {
        return "Generates a ArkTS client library using axios.";
    }
